...
function initBattery() {
    ...
    navigator.getBattery().then((batt) => {
        updateBattery = () => {
            ...
            if (level == 100) {
                batteryStatus.innerHTML = `Pełna bateria <i class="ri-battery-2-fill green-color"></i>`;
                batteryLiquid.style.height = "103%";
            } else if (level <= 20 & !batt.charging) {
                batteryStatus.innerHTML = `Niski poziom naładowania <i class="ri-plug-line animated-red animated-red"></i>`;
